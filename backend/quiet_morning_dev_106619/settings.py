"""
Django settings for quiet_morning_dev_106619 project.
...
ROOT_URLCONF = 'quiet_morning_dev_106619.urls'
...
WSGI_APPLICATION = 'quiet_morning_dev_106619.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_morning_dev_106619 API",
    "DESCRIPTION": "API documentation for quiet_morning_dev_106619 App",
    "VERSION": "v1",
}
